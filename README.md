...
![image](https://user-images.githubusercontent.com/63624229/81632274-d1fe1c80-9444-11ea-9046-7b525d3f2ac1.png)
    ...
    - 마이크로 서비스를 넘나드는 시나리오에 대한 트랜잭션 처리
        - 모두 inter-microservice 트랜잭션 : 동영상이 등록/수정 시 정책에 맞는지 확인, 동영상이 등록/수정/삭제 시 채널 정보 업데이트, 고객이 환급신청 시 환급 정책에 맞는지 확인의 모든 경우가 대부분이라 판단, Eventual Consistency 를 기본으로 채택한다
